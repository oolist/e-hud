...
public final class VanillaServerWarningScreen extends Screen {
    ...
    @Override protected void init() {
        int y = height / 2 + 42;
        addRenderableWidget(Button.builder(Component.literal("Continue"), button -> VersionClientUi.setScreen(minecraft, null))
        ...
        addRenderableWidget(Button.builder(Component.literal("Continue & don't show again"), button -> {
            ...
            ConfigManager.save(); VersionClientUi.setScreen(minecraft, null);
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.centeredText(font, "E HUD is not installed on this server", width / 2, top + 18, 0xFFFFB13B);
        graphics.centeredText(font, "You can still use normal client-side inspection.", width / 2, top + 42, 0xFFFFFFFF);
        graphics.centeredText(font, "Server-only data, operator policies, and teammate features will be unavailable.",
                width / 2, top + 56, 0xFFB7C8BC);
        graphics.centeredText(font, "Those controls will appear dimmed and inaccessible while connected.",
