...
final class ProfilesScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        if (presets().isEmpty()) graphics.centeredText(font, "No exported presets yet", width / 2, 104, 0xFF94A89A);
        graphics.centeredText(font, status, width / 2, height - 30, 0xFF9FD8AE);
    }
