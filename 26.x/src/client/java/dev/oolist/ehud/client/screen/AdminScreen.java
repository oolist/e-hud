...
final class AdminScreen extends Screen {
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.text(font, "E HUD ADMIN", 14, 11, 0xFFFFFFFF, true);
        graphics.text(font, "Disabled features are locked on every connected E HUD client", 14, 23, 0xFF9FD8AE, false);
