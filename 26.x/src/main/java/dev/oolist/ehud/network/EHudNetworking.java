...
public final class EHudNetworking {
    ...
    public static void initialize() {
        PayloadTypeRegistry.clientboundPlay().register(ServerPolicyPayload.TYPE, ServerPolicyPayload.CODEC);
        PayloadTypeRegistry.serverboundPlay().register(AdminUpdatePayload.TYPE, AdminUpdatePayload.CODEC);
